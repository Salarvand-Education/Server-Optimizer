...
#
# Copyright (C) 2024 Salarvand-Education
#
# my Github: https://github.com/Salarvand-Education/
...
display_menu() {
    ...
    echo
    echo "Coded By: https://github.com/Salarvand-Education/"
    echo "----------------------------------------"
...
sysctl_config() {
		echo -e "#Salarvand-Education optimize network traffic\n#Github: https://github.com/Salarvand-Education//\n" > /etc/sysctl.conf
...
cloner() {
    sed -i '/#Salarvand-Education optimize network traffic/,/#Github: https:\/\/github.com\/Salarvand-Education\//d' /etc/sysctl.conf
...
uninstall_script() {
    cloner
    echo "TCP Hybla settings have been removed."
    sudo sysctl -p
    sudo sysctl --system
}
